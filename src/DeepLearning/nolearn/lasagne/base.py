...
class NeuralNet(BaseEstimator):
    ...
    def __init__(
        ...
        more_params=None,
        hiddenLayer_to_output=-2, #Ido addition
        verbose=0,
        **kwargs
        ):
        if loss is not None:
        ...
        self.hiddenLayer_to_output = hiddenLayer_to_output #Ido addition
        self.layers = layers
        self.update = update
    ...
    def initialize(self):
        ...
        self.train_iter_, self.eval_iter_, self.predict_iter_, self.output_hidden_layer_ = iter_funcs #Ido addition
    ...
    def train_loop(self, X, y):
        ...
        while epoch < self.max_epochs:
            ...
            if not (np.isfinite(train_losses) or np.isfinite(valid_losses)):
                break
    ...
    #Ido addition:
    def output_hiddenLayer(self, x):
        return self.output_hidden_layer_(x)
