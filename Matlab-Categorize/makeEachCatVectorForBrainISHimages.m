function [ topCatNames ] = makeEachCatVectorForBrainISHimages( numTopCat )
...
%     end
    ...
    for i=13072:length(brainISHrepresentation)
        writeEachBrainCatVectors(brainISHrepresentation{i},topCatNames);
    end
